/**
 * TYPE_TAGS recognition + JSON record encoding for IPFS entities.
 *
 * Same canonical encoding as the S3/FS backends. IPFS stores opaque
 * bytes per content-addressed block; for custom entities we serialise
 * records as JSON and address them by CID, with the URI → CID
 * mapping kept in an in-memory index per entity.
 */
